...
wel = customtkinter.CTkLabel(root, text = "Hi, its YoCl, curent version-1.3.2, it's can be bugs", text_color="#57A3F2", font=customtkinter.CTkFont(size=24, weight="bold"))
wel.pack(pady=20)
