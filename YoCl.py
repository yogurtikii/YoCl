...
def goto():
    ...
    try:
        ...
        stl.destroy()
        stl = customtkinter.CTkLabel(mainf, text = f"We go to {target_path} successful", text_color="#78f960")
        stl.pack(anchor="w", pady=10, padx=20)
    except  OSError:
        stl.destroy()
...
wel = customtkinter.CTkLabel(welf, text = "Hi, its YoCl, curent version-1.3.2, it's can be bugs", text_color="#57A3F2", font=customtkinter.CTkFont(size=18, weight="bold"))
wel.pack(pady=20, anchor="w", padx=20,side="left")

image = customtkinter.CTkImage(light_image=Image.open("photo_2026-04-25_17-42-12.png"),dark_image=Image.open("photo_2026-04-25_17-42-12.png"),size=(100, 100))
